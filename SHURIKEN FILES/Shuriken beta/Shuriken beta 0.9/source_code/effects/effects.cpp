...
effects::effects()
{
    //Variables
    _shakeFrame = 0;
    _shakePositions[0] = Vector2f(420,288);
...
void effects::ShakeScreen(int force)
{
    _shakeFrame = 7;
    _shakePositions[0] = Vector2f(420,288);
    _shakePositions[1] = Vector2f(420-force,288);
    _shakePositions[2] = Vector2f(420+force,288);
    _shakePositions[3] = Vector2f(420,288-force);
    _shakePositions[4] = Vector2f(420,288+force);
    _shakePositions[5] = Vector2f(420-force,288-force);
    _shakePositions[6] = Vector2f(420-force,288+force);
    _shakePositions[7] = Vector2f(420+force,288-force);
}
