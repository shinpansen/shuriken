...
public:
    Box2DTools();
    static b2Body* CreateBox(b2World* world, Vector2i pos, b2Shape* shape, float friction, float density, float angle, int category);
    ...
    static b2Body* CreatePolygonBox(b2World* world, Vector2i pos, vector<Vector2f> vertices, float friction, float density, int category);
    ...
    static b2BodyType GetType(int i);
