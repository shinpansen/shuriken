...
mainGame::mainGame(RenderWindow* window, View* view, settings* settings)
{
    ...
    //Box2D - World
    _world = new b2World(b2Vec2(0.f, 70.f));
    ...
    _squareShape.setSize(Vector2f(840,576));
    _squareShape.setOrigin(420,288);
    _squareShape.setPosition(420,288);
    ...
    //Ninjas
    _ninja1 = new hero(0, Vector2i(100,180), _world, &_input1, &_effectBox, _projectileBox, &_soundBox, &_scoreManager, 3, _settings);
    ...
    //UI
    _mainMenu = new menuList(xmlReader::getTranslationTexts("menuMain", _settings->_language), Vector2f(420,425), &_input0, &_soundBox);
    _pauseMenu = new menuList(xmlReader::getTranslationTexts("pause", _settings->_language), Vector2f(420,260), &_input0, &_soundBox);
...
void mainGame::ResetRoom()
{
    //Reset objects
    if(_currentLevel == 0)
        _ninja1->ResetHero(0, 3, Vector2i(100,180));
    else if(_currentLevel == 1)
        _ninja1->ResetHero(0, 3, Vector2i(220,420));
    else
        _ninja1->ResetHero(0, 3, Vector2i(185,510));
...
void mainGame::RedrawUI()
{
    //Reset UI texts
    _mainMenu = new menuList(xmlReader::getTranslationTexts("menuMain", _settings->_language), Vector2f(420,425), &_input0, &_soundBox);
    _pauseMenu = new menuList(xmlReader::getTranslationTexts("pause", _settings->_language), Vector2f(400,300), &_input0, &_soundBox);
